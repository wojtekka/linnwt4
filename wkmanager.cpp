...
void owkmanager::psetfontsize(int s)
{
...
{
QString tip_open = tr(
  "<b>Laden einer Kurvendatei</B><BR>"
  "Laden einer abgespeicherten Kurve.<br> "
  "Mit dem \"aktiv\" Button kann man die<br>"
  "Kurve im Hintergrund als Grafik einblenden<br> "
  ,"tip_wkmanager");
QString tip_holen = tr(
  "<b>Holen einer Kurvendatei</B><BR>"
  "Holen der Wobbelkurve aus dem Arbeitsblatt<br> "
  "\"Wobbeln\". Mit dem \"aktiv\" Button kann<br>"
  " man die Kurve im Hintergrund als Grafik<br>"
  "einblenden<br> "
  ,"tip_wkmanager");
QString tip_wkmcolor = tr(
  "<b>Farbeinstellung</B><BR>"
  "Hiermit kann die Farbe jedes Kanales indivituell<br> "
  "eingestellt werden. Die Werte werden in der Datei<br>"
  "\"wkm.cfg\" automatisch gespeichert.<br>"
  ,"tip_wkmanager");
QString tip_save = tr(
  "<b>Speicher der Kurve</B><BR>"
  "Hiermit kann die Kurve noch nachtraeglich gespeichert<br> "
  "werden. Das Format ist gleich dem Format unter dem Menue<br>"
  "\"Kurve\" und kann ueber das Menue auch wieder eingelesen<br>"
  "werden.<br>"
  ,"tip_wkmanager");
...
void owkmanager::ssave5()
{
  save(5);
};

void owkmanager::ssave6()
{
  save(6);
};
...
void owkmanager::sholen5()
{
  emit wkmgetwobbel(5);
};

void owkmanager::sholen6()
{
  emit wkmgetwobbel(6);
};
...
void owkmanager::suebergabe(const TWobbel &awobbel, const QString &dateiname)
{
  QPen pen1, pen2;
  QString s, sz;
...
*/
void owkmanager::setHomePath(QDir &dir)
{
  homedir = dir;
}

void owkmanager::ladenconfig()
{
